...
export function Wishlist() {
  ...
  const wishlistIsEmpty = () => {
    return (
      <div className="mx-auto pt-16 pb-24 px-4 sm:px-6  lg:px-8 bg-white">
                  ...
                  <div className="flex jusitfy-between flex-col lg:flex-row items-center mt-10 w-full  space-y-4 lg:space-y-0 lg:space-x-4 xl:space-x-8">
                    <div className="w-full">
                      <Link
                        ...
                        className="focus:outline-none focus:ring-gray-800 focus:ring-offset-2 focus:ring-2 text-gray-800 w-full tracking-tight py-4 text-sm leading-4 hover:bg-gray-300 hover:text-gray-800  bg-white border border-gray-800"
                      >
                        More information
                      </Link>
                    </div>
