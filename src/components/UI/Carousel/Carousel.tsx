...
import { AiOutlineVerticalRight, AiOutlineVerticalLeft, AiFillCaretLeft, AiFillCaretRight } from "react-icons/ai";
import "./style.css";
...
export function Carousel() {
  ...
  return (
    <div ref={slideRef} className="w-full relative select-none">
      <img src={resources[currentIndex].imageUrl} className="slider-image slider shadow-[0px_22px_70px_4px_rgba(0,0,0,0.56)]" alt="" />
