...
export const Highlight = () => {
  return (
    <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:py-8">
      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 lg:gap-8 md:gap-12 gap-14 lg:px-20 md:px-12 px-4">
        <div>
          <svg
            width="32"
            height="32"
          ...
          <p className=" text-base leading-6 font-normal text-gray-600 mt-4 lg:w-full md:w-9/12 w-full">
            Free worldwide delivery over orders above $10000
          </p>
        </div>
